...
//        int count = 0;
//        int size=0;
//        Integer[] queue = new Integer[]{};
//        while (scanner.hasNext()){
//            if(count==0){
//                size = scanner.nextInt();
//            }else if(count==1){
//                queue = new Integer[size];
//                queue[0]=scanner.nextInt();
//            }else if(count>1&count<=size){
//                //收集数据
//                queue[count-1]=scanner.nextInt();
//                if(count==size){
//                    //开始排序去重
//                    List<Integer> quList = Arrays.asList(queue);
//                    Collections.sort(quList);
//                    HashSet<Integer> hashSet = new HashSet();
//                    for (Integer c:quList) {
//                        hashSet.add(c);
//                    }
